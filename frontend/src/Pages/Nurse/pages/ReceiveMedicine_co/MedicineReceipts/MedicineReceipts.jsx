                ...
                {filteredMedicineRequests.map(medicine => {
                  ...
                  return (
                    <tr key={medicine.id} className={statusInfo.class + '-row'}>
                      <td>{medicine.id}</td><td>{medicine.studentName}</td><td>{medicine.requestedBy}</td><td>{new Date(medicine.startDate).toLocaleDateString('vi-VN')}</td><td><span className={`status-badge ${statusInfo.class}`}>{statusInfo.text}</span></td><td>
                            ...
                            <div className="dropdown-container">
                              ...
                              {dropdownId === medicine.id && (
                                <div className="dropdown-menu">
                                  <div className="dropdown-item" onClick={() => handleActionSelect(medicine.id, 'APPROVED')}>Phê duyệt</div>
                                  <div className="dropdown-item" onClick={() => handleActionSelect(medicine.id, 'REJECTED')}>Từ chối</div>
                                </div>
                              )}
                            </div>
                          )}
