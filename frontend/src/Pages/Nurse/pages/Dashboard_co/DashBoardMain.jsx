...
const Dashboard = ({ activeTab: initialActiveTab = "dashboard" }) => {
  ...
  const dashboardContent = (
    <>
      ...
      <div className="content-container">
        ...
        {activeTab === "medical-events" && <MedicalEventsPage />}
        {activeTab === "vaccination" && <VaccinationPage />}
        {activeTab === "student-records" && <StudentRecordsPage />}
        {activeTab === "consultation" && <Consultation />}
        {activeTab === "health-checkups" && <HealthCheckupsPage />}
